...
import Pills from '../index.js';

storiesOf('React Taggy', module)
    .add('Text=String. No multi-word entities provided.', () => (
        <Pills
    ...
    .add('Text=String. Multi-word entities provided.', () => (
        <Pills
            text='Michael Jordan ate lunch yesterday in Chicago.'
            spans = {[
    ...
    .add('Text=Array. No multi-word entities provided.', () => (
        <Pills
            text={['Michael', 'Jordan', 'ate', 'lunch', 'yesterday', 'in', 'Chicago', '.']}
            spans = {[
                {type: 'person', index: 0},
    ...
    .add('Text=Array. Multi-word entities provided.', () => (
